 ...
 */
abstract class Hilt_FollowedArtistsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FollowedArtistsFragment() {
    super();
  }

  Hilt_FollowedArtistsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FollowedArtistsFragment_GeneratedInjector) this.generatedComponent()).injectFollowedArtistsFragment(UnsafeCasts.<FollowedArtistsFragment>unsafeCast(this));
    }
  }
