 ...
 */
abstract class Hilt_DetailArtistFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DetailArtistFragment() {
    super();
  }

  Hilt_DetailArtistFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DetailArtistFragment_GeneratedInjector) this.generatedComponent()).injectDetailArtistFragment(UnsafeCasts.<DetailArtistFragment>unsafeCast(this));
    }
  }
