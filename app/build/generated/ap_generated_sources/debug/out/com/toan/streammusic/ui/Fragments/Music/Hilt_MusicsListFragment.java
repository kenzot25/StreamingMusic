 ...
 */
abstract class Hilt_MusicsListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MusicsListFragment() {
    super();
  }

  Hilt_MusicsListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MusicsListFragment_GeneratedInjector) this.generatedComponent()).injectMusicsListFragment(UnsafeCasts.<MusicsListFragment>unsafeCast(this));
    }
  }
