 ...
 */
abstract class Hilt_VideosListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_VideosListFragment() {
    super();
  }

  Hilt_VideosListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VideosListFragment_GeneratedInjector) this.generatedComponent()).injectVideosListFragment(UnsafeCasts.<VideosListFragment>unsafeCast(this));
    }
  }
