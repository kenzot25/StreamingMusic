...
public class FragmentAlbumBindingImpl extends FragmentAlbumBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.albumLikeButton, 3);
        sViewsWithIds.put(R.id.albumImageView, 4);
        sViewsWithIds.put(R.id.albumNameTextView, 5);
        sViewsWithIds.put(R.id.albumArtistTextView, 6);
        sViewsWithIds.put(R.id.albumMusicsCountTextView, 7);
        sViewsWithIds.put(R.id.albumPlayButton, 8);
        sViewsWithIds.put(R.id.albumDownloadButton, 9);
        sViewsWithIds.put(R.id.albumMusicsRecyclerView, 10);
    }
    // views
    // variables
    // values
    ...
    private FragmentAlbumBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.frameLayout13.setTag(null);
        setRootTag(root);
        // listeners
        invalidateAll();
    }
