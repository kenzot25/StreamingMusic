 ...
 */
abstract class Hilt_VideoPlayerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_VideoPlayerFragment() {
    super();
  }

  Hilt_VideoPlayerFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VideoPlayerFragment_GeneratedInjector) this.generatedComponent()).injectVideoPlayerFragment(UnsafeCasts.<VideoPlayerFragment>unsafeCast(this));
    }
  }
