 ...
 */
abstract class Hilt_LikedFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LikedFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LikedFragment_GeneratedInjector) this.generatedComponent()).injectLikedFragment(UnsafeCasts.<LikedFragment>unsafeCast(this));
    }
  }
