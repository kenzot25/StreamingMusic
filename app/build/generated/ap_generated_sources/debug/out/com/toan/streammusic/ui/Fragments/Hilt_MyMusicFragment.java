 ...
 */
abstract class Hilt_MyMusicFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MyMusicFragment() {
    super();
  }

  Hilt_MyMusicFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MyMusicFragment_GeneratedInjector) this.generatedComponent()).injectMyMusicFragment(UnsafeCasts.<MyMusicFragment>unsafeCast(this));
    }
  }
